...
def vild_main(image_path, category_name_string, params, temperature=100.0, use_softmax=False):
  ...
  alpha = 0.5
  #################################################################
  image,image_height,image_width,valid_indices,detection_roi_scores,detection_boxes,detection_masks,detection_visual_feat,rescaled_detection_boxes = extract_roi_vild(image_path,overall_fig_size,params)
  #################################################################
